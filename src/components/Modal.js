...
const navigate = useNavigate();
  ...
  function handleSubmit(e) {
    e.preventDefault();
    const newPlaylist = {name:listName,capa:"blankPlaylist.png",descricao: "a",autor: "Spotifly",quantidadeFaixas: "2 faixas",quantidadeCurtidas: "2.450 curtidas",userId:currentUser.id,musicas:[]}
    var aux=currentUser 
